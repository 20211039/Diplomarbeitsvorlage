...
mit Tintenstrahldruckern\index{Drucker!Tintenstrahldrucker} sind \emph{nicht} ausreichend. Auch das
...
auf einem Farb-Laserdrucker\index{Drucker!Farb-Laserdrucker} ausdrucken und dem Dokument beifügen.
...
Option "`Fit to page"' im Druckmenü\index{Drucker!Druckmenü} verursacht, wobei die Seiten
meist zu klein ausgedruckt werden. überprüfen Sie daher die Größe
des Ausdrucks\index{Drucker!Ausdruck} anhand der eingestellten Zeilenlänge oder mithilfe
...
Die Endfassung der Diplomarbeit\index{Diplomarbeit} ist in fest gebundener Form einzureichen.%
